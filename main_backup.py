...
def game(screen, fonts, player, assets, ui=None, food_assets=None):
    font, small = fonts
    clock = pygame.time.Clock()
...
def two_player_game(screen, fonts, name1, name2, assets_p1, assets_p2, ui=None, food_assets=None):
...
def main():
    ...
    while True:
        ...
        if choice == "2 PLAYER":
            ...
            p1, p2 = two_player_game(screen, fonts, name1, name2, assets_p1, assets_p2, ui, food_assets)
        ...
        score, died = game(screen, fonts, player, assets_p1, ui, food_assets)
